...
class top_rated{
    ...
    function row_count(){
        ...
        $this->sql = "SELECT id FROM movie_details WHERE avg_vote > 8";
    ...
    function top_featured_list(){
        ...
        // $sql ="INSERT INTO `RegistrationTable` (Username,Pass ,mobile,email_id) VALUES (?,?,?,?)";
        // echo $sql;
        ...
        $this->sql = "SELECT * FROM movie_details WHERE avg_vote > 8 LIMIT $offset,$this->limit";
