    ...
    class top_featured{
        ...
        function row_count(){
            ...
            $db1 = new database();
             ...
             $this->sql = "SELECT * FROM movie_details WHERE year BETWEEN '".$this->year2."' AND '".$this->year1."' and country = 'india'";
        ...
        function top_featured_list(){
            ...
            $this->sql = "SELECT * FROM movie_details WHERE year BETWEEN '".$this->year2."' AND '".$this->year1." ' and country = 'india' LIMIT $offset,$this->limit";
