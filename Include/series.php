...
<div>
        ...
        <h4 style="color:white;" >Add show</h4>
    
</div>
<form class="form-inline my-2   search my-lg-0 series-add" id="my-form" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>" enctype="multipart/form-data">
    <div class="d-flex flex-column flex-lg-row flex-xl-row flex-sm-column flex-md-column">
        <section  class="" >
            ...
            <input class="form-control mr-sm-2 " type="text" placeholder="Genre" name="genre" aria-label="Search" required="">
        ...
        <section class="">
            ...
            <input class="form-control mr-sm-2 " type="text" placeholder="Age Rating" name="age_rating"  required="">
            <input class="form-control mr-sm-2 " type="text" placeholder="Episodes Per Season" name="noe" required="">
        </section>
    ...
    <div class="d-flex flex-row">
        ...
        <section>
            ...
            <input class="form-control mr-sm-2 " type="text" placeholder="Show category" name="rated" required=""> 
        </section>
    ...
    <div class="d-flex flex-column">
        <section class="d-flex flex-row">
            <input class="form-control mr-sm-2 " type="text" placeholder="Duration" name="duration" required=""> 
        ...
        <section class="d-flex flex-row">
            <input class="form-control mr-sm-2 " type="text" placeholder="No of Seasons" name="nos" required=""> 
    ...
    <button class="series-test-button btn btn-primary">test</button>
