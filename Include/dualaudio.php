<?php
    ...
    class dualaudio{
        ...
        function view(){
            ...
            $this->sql = "SELECT imdb_title_id FROM  movies where language = 'hindi' and language = 'english'  ";
            ...
            $this->sql = "SELECT * FROM movies WHERE  language = 'hindi' and language = 'english'   LIMIT $this->offset,$this->limit";
